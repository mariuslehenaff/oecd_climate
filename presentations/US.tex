...
\caption{indices}
\begin{center}
\scalebox{.33}{\input{../tables/US/indices_US.tex}}
\end{center}
\end{table}
\end{frame}
...
\begin{center}
\scalebox{.28}{\input{../tables/US/support_all_indices_US.tex}}
\end{center}
\end{table}
\end{frame}
...
\includegraphics[width=.5\textwidth]{../figures/US/coef_indices_US.png} \\
\end{figure}
\end{frame}
...
\begin{figure}[h!]
\caption{Coefficients from regressions}
\includegraphics[width=.5\textwidth]{../figures/US/coef_support_indices_US.png} \\
\end{figure}
\end{frame}
