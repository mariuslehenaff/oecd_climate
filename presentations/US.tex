...
\title[Climate survey - US]{\huge Climate survey - US pilot}
\author[OECD]{OECD \\ \vspace{1cm}
     Results for the US: (partial) sample of 1,738 respondents (full will be 2,000).}% Representative along the \\gender, age, income, region and rural/urban dimensions but not representative along the education, ethnicity/race, vote and occupation dimensions. %\\Results are weighted along the gender, income, region, living in a metropolitan area, age, and race dimensions}
...
\item With a green infrastructure program, how many people could find a job in green sectors in the U.S.?
...
\includegraphics[width=.7\textwidth, inner]{../figures/US/CC_dynamic_US.png}
\centering
\caption{Which of the following elements contribute to climate change? (Multiple answers are possible)  }
\includegraphics[width=.7\textwidth, inner]{../figures/US/score_GHG_US.png}
...
\begin{frame}{Policy effects}%\addtocounter{framenumber}{-1}
...
\begin{center}
\scalebox{.59}{\input{../tables/US_1.tex"}}
\end{center}
...
\begin{center}
\scalebox{.7}{\input{../tables/US_2.tex"}}
\end{center}
...
\begin{center}
\scalebox{.7}{\input{../tables/US_3.tex"}}
\end{center}
