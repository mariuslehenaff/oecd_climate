...
\usetheme{Boadilla}
% TODO! heating_DE, burden_sharing_DE, indexes_DE
...
%\caption{Indexes}
%\begin{center}
%\scalebox{.33}{\input{../tables/DE/indexes_DE.tex}}
%\end{center}
%\end{table}
%\end{frame}
...
%\begin{center}
%\scalebox{.28}{\input{../tables/DE/support_all_indexes_DE.tex}}
%\end{center}
%\end{table}
%\end{frame}
...
%\includegraphics[width=.5\textwidth]{../figures/DE/coef_indexes_DE.png} \\
%\end{figure}
%\end{frame}
%
%
...
%\begin{figure}[h!]
%\caption{Coefficients from regressions}
%\includegraphics[width=.5\textwidth]{../figures/DE/coef_support_indexes_DE.png} \\
%\end{figure}
%\end{frame}
