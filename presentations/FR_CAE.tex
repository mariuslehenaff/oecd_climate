...
\begin{figure}	
	\includegraphics[width=.88\paperwidth]{../figures/FR/Coefplot_SetAB_index_knowledge.png}
...
\begin{figure}
	\includegraphics[width=.88\paperwidth]{../figures/FR/Coefplot_SetAB_index_main_policies.png}
