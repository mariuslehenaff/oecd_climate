...
\begin{frame}{}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\caption{\% of positive responses by support for yellow jackets}
\includegraphics[width=.7\paperwidth]{../figures/FR/positive_all_by_yellow_jacket_FR.png} \\
\end{figure}
\end{frame}
...
\includegraphics[width=.45\paperwidth]{../figures/FR/coef_support_indexes_FR.png} \\
\tiny{Note: Variables used in the analysis but not displayed: dominant origin in the country, gender, and income. The policy support for all variable is an indicator variable equal to one if on average among the three policies the respondent somewhat or strongly support the policies.}
\end{figure}
\end{frame}
