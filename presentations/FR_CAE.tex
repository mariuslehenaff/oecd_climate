...
\begin{frame}{Proposed Outline for the Paper}
	\begin{enumerate}
		\ip I. Methodology of the surveys
		\ip II. Knowledge and misperceptions. Who knows more and where information is lacking
		\ip III. Who supports climate policies? Key heterogeneities and respondents' profiles
		\ip IV. The underlying mechanisms of support. Mechanisms and information treatments
	\end{enumerate}
\end{frame}
...
\includegraphics[width=.7\textwidth]{../figures/FR/gelbach_vote_agg_no_fairness_index_main_policies} \\
%\caption{Could you trust the federal goverment to implement the following policies}
{\tiny \textit{Notes:} Each bar indicates the share of the partisan gap explained by each of the factors. The unexplained share is 42\%. Coefficient of partial model is .257, coefficient of full model is .110}
\end{figure}
\end{frame}
...
\begin{figure}[h!]
%\caption{… main climate policies}
\includegraphics[width=.7\textwidth]{../figures/FR/gelbach_young_no_fairness_index_main_policies} \\
%\caption{Could you trust the federal goverment to implement the following policies}
{\tiny \textit{Notes:} Each bar indicates the share of the age gap explained by each of the factors. The unexplained share is 0\%. Coefficient of partial model is .094, coefficient of full model is .001}
\end{figure}
\end{frame}
...
%\caption{Could you trust the federal goverment to implement the following policies}
{\tiny \textit{Notes:} Each bar indicates the share of the diploma gap explained by each of the factors. The unexplained share is 33\%. Coefficient of partial model is -.150, coefficient of full model is -.050}
\end{figure}
\end{frame}
