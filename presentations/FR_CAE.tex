...
\ip Unlike old-style surveys (that measure variables now better captured in admin data). 
...
% TODO:
%- Rajouter slide sur utilité des surveys (insister sur differences avec opinion polls) ~slides4/5
