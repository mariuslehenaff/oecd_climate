...
\begin{frame}{Support – Political}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\caption{Policy support by political affiliation}
\includegraphics[width=.4\paperwidth]{../figures/FR/support_by_political_FR.png} \\
\end{figure}

\begin{figure}[h!]
\caption{Policy support by vote}
\includegraphics[width=.4\paperwidth]{../figures/FR/support_by_vote_agg_FR.png} \\
\end{figure}
\end{frame}


\begin{frame}{Support – Urbanity}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\caption{Policy support by urban category}
\includegraphics[width=.4\paperwidth]{../figures/FR/support_by_urban_FR.png} \\
\end{figure}

\begin{figure}[h!]
\caption{Policy support by availability of public transport}
\includegraphics[width=.4\paperwidth]{../figures/FR/support_by_availability_transport_FR.png} \\
\end{figure}
\end{frame}

\begin{frame}{Support – Sector}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\caption{Policy support by working sector}
\includegraphics[width=.7\paperwidth]{../figures/FR/support_by_polluting_sector_FR.png} \\
\end{figure}
\end{frame}

\subsubsection{Willingness to change}

\begin{frame}{Willingness – Political}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\caption{Willingness by political affiliation}
\includegraphics[width=.4\paperwidth]{../figures/FR/willing_by_political_FR.png} \\
\end{figure}

\begin{figure}[h!]
\caption{Willingness by vote}
\includegraphics[width=.4\paperwidth]{../figures/FR/willing_by_vote_agg_FR.png} \\
\end{figure}
\end{frame}


\begin{frame}{Willingness – Urbanity}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\caption{Willingness by urban category}
\includegraphics[width=.4\paperwidth]{../figures/FR/willing_by_urban_FR.png} \\
\end{figure}

\begin{figure}[h!]
\caption{Willingness by availability of public transport}
\includegraphics[width=.4\paperwidth]{../figures/FR/willing_by_availability_transport_FR.png} \\
\end{figure}
\end{frame}

\begin{frame}{Willingness – Sector and Income}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\caption{Willingness by urban category}
\includegraphics[width=.4\paperwidth]{../figures/FR/willing_by_polluting_sector_FR.png} \\
\end{figure}

\begin{figure}[h!]
\caption{Willingness by availability of public transport}
\includegraphics[width=.4\paperwidth]{../figures/FR/willing_by_income_FR.png} \\
\end{figure}
\end{frame}
