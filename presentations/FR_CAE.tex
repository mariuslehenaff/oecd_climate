...
\bigskip
%- Dire que le groupe de contrôle est utilisé
%- Mettre in Appendix des sections moins interessantes par exemple “socio demographics”
%- pour le vote, par pays comme ca, il faut mettre le nom des partis/candidats directement. 
%- Skip the essay questions. 
%- Pour le traitement, c’est le nombre de responses justes out of how many questions? (precise sur la slide). ET move it to aPpendix, clickable. (slides 31 and 32)
%- In climate knowledge part, could you please put accurate answer on the slide too?
%- The donation question and WTP question can be taken out. I am interested in the treatment effects on those, not in the baseline. 
%- I like the section that does the comparison of the 3 policies. This duplicates the info previously shown separately, right? if that’s true, then please merge everything into that one section, where on one slide, please put the definition of the policies and then move to those comparison graphs. 
%- Move trust and institutions to Appendix. 
%- also move the section “feedback” to Appendix. 
...
\begin{frame}{Little interest for politics and environtal activism}%\addtocounter{framenumber}{-1}
\vspace{-.5cm}
\begin{figure}[h!]
...
\begin{frame}{Climate change knowledge: Acknowledged but not absorbing}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
...
\begin{frame}{Climate change knowledge: Limited understanding of the stakes}%\addtocounter{framenumber}{-1}
\begin{figure}%[h!]
\centering
...
\includegraphics[width=.55\paperwidth]{../figures/FR/CC_dynamic_FR.png}

\end{figure}
\end{frame}

\begin{frame}{Climate change knowledge: Prevalence of CO$_\text{2}$}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
...
\begin{frame}{Climate change knowledge: Underestimate EU emissions}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
...
\newline\footnotesize{\textit{Right answer: Likely: Severe droughts and heatwaves; Rising sea levels / Unlikely: More frequent volcanic eruptions}}}
...
\begin{frame}{Attitudes and risks: Not a generational problem}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
...
\begin{frame}{Technological pessimistic \& Self optimism}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
...
% out
\begin{frame}{Factors needed to change lifestyle: role of most well-off}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
...
\begin{frame}{Support ban on combustion-engine cars with alternatives}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
...
\begin{frame}{Funding of Green Infrastructure Program}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
...
% out
\begin{frame}{France climate policy}% TODO:other_countries "US" \addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
