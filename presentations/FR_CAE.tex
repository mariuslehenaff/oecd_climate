...
\begin{frame}{Gelbach decomposition of the partisan gap (left voters vs. the rest) in support for…}%\addtocounter{framenumber}{-1}
\vspace{-.2cm}
\begin{figure}[h!]
...
\begin{frame}{Gelbach decomposition of the age gap ( below 35 vs. the rest) in support for…}%\addtocounter{framenumber}{-1}
\vspace{-.2cm}
\begin{figure}[h!]
\caption{… main climate policies}
...
\begin{frame}{Gelbach decomposition of the diploma gap (college education vs. the rest) in support for…}%\addtocounter{framenumber}{-1}
\vspace{-.2cm}
\begin{figure}[h!]
\caption{… main climate policies}
