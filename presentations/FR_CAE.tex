...
\bbs
\ip \textcolor{blue}{Average Support} 
\bbs 
\ip Average of responses in [-2;+2] to questions on support for a ban on combustion-engine cars, a green infrastructure program, and a carbon tax with cash transfers
\ee
\ip \textcolor{blue}{Inde all policies} % factual, but also about magnitude and importance of 
\bbs 
\ip Average of all support variables transformed in z-scores
\ee
...
\ip \textcolor{blue}{Oppose climate policies and think they will have negative distributive consequences} \textit{(26.1\% of the sample)}
	...
	\end{itemize}
\ip \textcolor{blue}{Support most of the climate policies and believe in their effectiveness. Willing to make some changes} \textit{(33.5\% of the sample)}
	\begin{itemize}
