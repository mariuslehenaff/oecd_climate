...
\usetheme{Boadilla}
% TODO! Replace Danish, Denmark, 600 DKK (100€), 2 kr. pr. liter, 3700 DKK, and (only after:) DK; change first page; mile; half a pound/200g
\usepackage{gensymb}
...
\title[Climate survey - Denmark]{\huge Climate survey - Denmark}
\author[OECD]{OECD \\ \vspace{1cm}
     Sample of 2,011 respondents representative along the \\gender, age, income, region and rural/urban dimensions. \\ These variables define the quotas and the survey weights, used throughout.}% Representative along the \\gender, age, income, region and rural/urban dimensions but not representative along the education, ethnicity/race, vote and occupation dimensions. %\\Results are weighted along the gender, income, region, living in a metropolitan area, age, and race dimensions}
...
%\includegraphics[width=.5\textwidth]{../figures/DK/race_DK_comp.png}\\
\end{figure}
\end{frame}
...
%\includegraphics[width=.7\textwidth]{../figures/DK/vote_DK_comp.png} \\
%\end{figure}
%\end{frame}
...
%\includegraphics[width=.5\textwidth]{../figures/DK/region_DK_comp.png}
\end{figure}
\end{frame}
...
% \includegraphics[width=.8\textwidth]{../figures/DK/occupation_DK.png} \\
...
% \captionsetup{justification=centering}
% \caption{Have you or a member of your household been laid off or had to take a cut in your salary or wages due to the COVID-19 pandemic?}
% \includegraphics[width=.6\textwidth]{../figures/DK/hit_by_covid_DK.png} # TODO choose
% \end{figure}
% \end{frame}
...
% \caption{Which candidate did you vote for in the last presidential election?}
% \includegraphics[width=.6\textwidth]{../figures/DK/vote_all_DK.png} \\
% \caption{Did you vote in the 2016 Danish presidential election?}
% \includegraphics[width=.54\textwidth]{../figures/DK/vote_participation_2016_DK.png}\\
\end{figure}
\end{frame}
...
%\includegraphics[width=.8\textwidth]{../figures/DK/political_affiliation_DK.png}\\
\end{figure}
\end{frame}
...
%\item In the absence of ambitious action against climate change, how frequent will extreme temperatures occur across the Danish by the end of the century?
%\item What is the emission limit described in the video? 
%\item How would a green infrastructure program be financed?
%\end{itemize}
%
%% \includegraphics[width=.7\textwidth]{../figures/DK/know_treatment.png}
%\includegraphics[width=.7\textwidth]{../figures/DK/know_treatment_climate_DK.png} \\
%\vspace{.5cm}
%\includegraphics[width=.7\textwidth]{../figures/DK/know_treatment_policy_DK.png}
%\end{figure}
%\end{frame}
...
% \includegraphics[width=.5\textwidth]{../figures/DK/CC_real_DK.png} \\
% \centering
% \caption{\textit{If answered yes to previous question:} What part of climate change do you think is due to human activity?}
% \includegraphics[width=.6\textwidth]{../figures/DK/CC_anthropogenic_non_deniers_DK.png} # TOOD choose
...
% \includegraphics[width=.5\textwidth]{../figures/DK/scores_footprint_DK.png} \\
% \centering
% \caption{Rank the Danish/China/Western Europe/India in terms of GHG footprint}
% \includegraphics[width=.6\textwidth]{../figures/DK/score_footprint_regions_DK.png}
% \vspace{.2cm}
% % \\
...
%    %     \item Around 20\% also think that ambitious policies would have strong negative effects on their lifestyle and around 30\% think ambitious policies would have negative effects on the Danish economy. 
...
% \includegraphics[width=.7\textwidth]{../figures/DK/pro_ambitious_policies_DK.png}
\end{figure}
\end{frame}
...
%\begin{figure}[h!]
%\centering
%\includegraphics[width=.6\textwidth]{../figures/DK/future_richness_DK.png}
%\end{figure}
%\end{frame}
...
\includegraphics[width=.7\textwidth]{../figures/DK/wtp_DK.png} % TODO! scale. TODO: wtp_DK_anthropogenic?
\end{figure}
\end{frame}
...
%    \begin{itemize}
%        \item The majority thinks that the Danish should do more whether other countries do more or less.
...
\vspace{-.5cm}
\begin{figure}[h!]
%\caption{\textit{i)} To reduce fuel consumption for heating and cooling, the Danish government could subsidize half of the costs to renovate the insulation of residential buildings to meet a certain energy efficiency standard. \\
%\textit{ii)} Imagine that the Danish government makes it mandatory for all residential buildings to have insulation that meets a certain energy efficiency standard before 2040. The government would subsidize half of the insulation costs to help households with the transition. \\
...
% \vspace{.5cm}
% \includegraphics[width=.64\textwidth]{../figures/DK/ban_incentives_DK.png}
\end{figure}
\end{frame}
...
%\includegraphics[width=.6\textwidth]{../figures/DK/willing_limit_flying_DK_pol.png} \\
%\vspace{.5cm}
...
%\includegraphics[width=.7\textwidth]{../figures/DK/willing_limit_beef_DK_pol.png} \\
%\end{figure}
%\end{frame}
%
...
%\includegraphics[width=.7\textwidth]{../figures/DK/future_richness_DK_pol.png} \\
%\vspace{.5cm}
...
%\includegraphics[width=.7\textwidth]{../figures/DK/effect_halt_CC_lifestyle_DK_pol.png} \\
%\end{figure}
%\end{frame}
%
...
%\includegraphics[width=.6\textwidth]{../figures/DK/policies_win_lose_self_DK_pol.png} \\
%\vspace{.1cm}
...
%\includegraphics[width=.5\textwidth]{../figures/DK/CC_affects_self_DK_pol.png}
%\end{figure}
%\end{frame}
%
...
%\includegraphics[width=.6\textwidth]{../figures/DK/policies_support_DK_pol.png} \\
%\vspace{.5cm}
...
%\includegraphics[width=.6\textwidth]{../figures/DK/global_assembly_support_DK_pol.png} \\
%\end{figure}
%\end{frame}
%
...
%\vspace{-.5cm}
%\begin{figure}[h!]
%\caption{Do you agree or disagree with the following statement? This policy would have a negative effect on the Danish economy and employment -- by Political affiliation}
%\includegraphics[width=.8\textwidth]{../figures/DK/policies_negative_effect_DK_pol.png} \\
%\end{figure}
%\end{frame}
...
\begin{center}
\scalebox{.59}{\input{../tables/DK_1.tex}}
\end{center}
...
\begin{center}
\scalebox{.7}{\input{../tables/DK_2.tex}}
\end{center}
...
\begin{center}
\scalebox{.7}{\input{../tables/DK_3.tex}}
\end{center}
...
\caption{indices}
\begin{center}
\scalebox{.33}{\input{../tables/DK/indices_DK.tex}}
\end{center}
\end{table}
\end{frame}
...
\begin{center}
\scalebox{.28}{\input{../tables/DK/support_all_indices_DK.tex}}
\end{center}
\end{table}
\end{frame}
...
\includegraphics[width=.5\textwidth]{../figures/DK/coef_indices_DK.png} \\
\end{figure}
\end{frame}
...
\begin{figure}[h!]
\caption{Coefficients from regressions}
\includegraphics[width=.5\textwidth]{../figures/DK/coef_support_indices_DK.png} \\
\end{figure}
\end{frame}
