...
% 	\centering
% 	\caption{%\textit{Comparison of responses to each policy question:} 
%Do you agree or disagree with the following statement? \textit{The policy} would be \textcolor{blue}{costly to fight climate change}} % TODO!
% 	\includegraphics[width=\textwidth]{../figures/country_comparison/policies_cost_effective_positive_countries.png}
