...
\begin{itemize}
	...
	\item Both treatment have a negative effects on left-leaning persons
	\item Policy treatment has a negative effect on both right- and left-leaning persons on thinking that rich people are responsible for CC \newline
...
\begin{center}
\scalebox{.3}{\input{../../tables/heterogeneity/main_results_het_left_right_all.tex}}
\end{center}
...
income quartiles, employment tatus, age, political affiliation, living in an urban area, and the country is which the survey occured.}
\end{table}
\end{frame}
...
\begin{center}
\scalebox{.4}{\input{../../tables/heterogeneity/main_results_het_origin_all.tex}}
\end{center}
\end{table}
\end{frame}
...
\begin{center}
\scalebox{.3}{\input{../../tables/heterogeneity/main_results_het_employment_all.tex}}
\end{center}
\end{table}
\end{frame}
...
\begin{center}
\scalebox{.25}{\input{../../tables/heterogeneity/main_results_het_age_all.tex}}
\end{center}
\end{table}
\end{frame}
...
\begin{frame}{Main Results}
\begin{itemize}
	\item Importance of political-leaning and age on support \newline
	\item Believing that policies are efficient is a key determinant of the support for all policies
	\item Thinking that climate change will/is affect(ing) oneself way more important than being actually vulnerable to climate change \newline
	...
	\item For the geographical gap, believing that climate change will affect oneself is also an important determinant.
	\item Being concerned about climate change only plays a role at the margins.
\end{itemize}
\end{frame}
...
\begin{figure}[h!]
\caption{… all climate policies}
\includegraphics[width=.55\textwidth]{../../figures/Gelbach/gelbach_urban_all_policies_D2SD} \\
%\caption{Could you trust the federal goverment to implement the following policies}
