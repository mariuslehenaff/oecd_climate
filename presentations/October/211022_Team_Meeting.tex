...
\begin{center}
\scalebox{.43}{\input{../../tables/heterogeneity/main_results_het_employment_all_small.tex}}
\end{center}
\end{table}
\end{frame}
...
\begin{center}
\scalebox{.35}{\input{../../tables/heterogeneity/main_results_het_age_all_small.tex}}
\end{center}
\end{table}
\end{frame}
