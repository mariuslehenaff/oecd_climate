...
\begin{center}
\scalebox{.4}{\input{../../tables/heterogeneity/main_results_het_left_right_all.tex}}
\end{center}
...
\begin{center}
\scalebox{.45}{\input{../../tables/heterogeneity/main_results_het_origin_all.tex}}
\end{center}
\end{table}
\end{frame}
...
\begin{center}
\scalebox{.4}{\input{../../tables/heterogeneity/main_results_het_employment_all.tex}}
\end{center}
\end{table}
\end{frame}
...
\begin{center}
\scalebox{.32}{\input{../../tables/heterogeneity/main_results_het_age_all.tex}}
\end{center}
\end{table}
\end{frame}
