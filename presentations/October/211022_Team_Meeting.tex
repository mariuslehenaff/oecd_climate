...
\begin{frame}{Variance Decomposition -- Individual Characteristics}%\addtocounter{framenumber}{-1}
\vspace{-.1cm}
...
\begin{frame}{Variance Decomposition -- Individual Characteristics and Indices}%\addtocounter{framenumber}{-1}
\vspace{-.1cm}
{\footnotesize $R^2$ = 64.75\%}
\begin{figure}[h!]
\includegraphics[width=.6\textwidth]{../../figures/Gelbach/lmg_all_policies_w_controls_non_standardized} \\
%\caption{Could you trust the federal goverment to implement the following policies}
\end{figure}
\end{frame}

\begin{frame}{Variance Decomposition -- Indices}%\addtocounter{framenumber}{-1}
\vspace{-.1cm}
