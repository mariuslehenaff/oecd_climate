...
\begin{frame}{Education and Origin}%\addtocounter{framenumber}{-1}
    % \begin{itemize}
...
\vspace{.3cm}
\caption{Respondent's origin is the dominant one in their country (US: white only; Other: national)} % TODO
...
\begin{frame}{Summary of Knowledge}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
%\caption{Impacts of climate change}
%\vspace{2mm}
...
\begin{frame}{Affected by Climate Change}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
...
\begin{frame}{Behavior Summary}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
...
\begin{frame}{Summary Views on Future}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
% \caption{How likely is it that human kind halt climate change by the end of the century?}
% \includegraphics[width=.7\textwidth]{../figures/country_comparison/CC_will_end_countries.png}\\
...
\begin{frame}{Views on who is responsible }%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
\centering
% \caption{How likely is it that human kind halt climate change by the end of the century?}
% \includegraphics[width=.7\textwidth]{../figures/country_comparison/CC_will_end_countries.png}\\
