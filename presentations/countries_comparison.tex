...
\includegraphics[width=.9\textwidth]{../figures/country_comparison/education_countries.png} \\
\vspace{.3cm}
%\caption{What race or ethnicity do you identify with? (Multiple answers are possible)} % TODO
%\includegraphics[width=.5\textwidth]{../figures/country_comparison/race_FR_comp.png}\\
\end{figure}
\end{frame}
...
%\includegraphics[width=.7\textwidth]{../figures/country_comparison/vote_FR_comp.png} \\
%\end{figure}
%\end{frame}
...
%\includegraphics[width=.5\textwidth]{../figures/country_comparison/region_FR_comp.png}
\end{figure}
...
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/gender_FR_comp.png} \\
% \centering
% \caption{How old are you?}
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/age_FR_comp.png}
% \end{figure}
% \end{frame}
...
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/income_FR_comp.png} \\
% \vspace{.5cm}
...
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/wealth_FR.png} \\
% \end{figure}
% \end{frame}

\begin{frame}{Hit by covid}%\addtocounter{framenumber}{-1}
\begin{figure}[h!]
% \centering
% \captionsetup{justification=centering}
% \caption{What is your employment status?}
% \includegraphics[width=.8\textwidth]{../figures/country_comparison/employment_status_FR.png} \\
% \vspace{.5cm}
% \caption{Which category best describes your main occupation (or last one if not currently employed)?}
% \includegraphics[width=.8\textwidth]{../figures/country_comparison/occupation_FR.png} \\
...
% \captionsetup{justification=centering}
% \caption{Have you or a member of your household been laid off or had to take a cut in your salary or wages due to the COVID-19 pandemic?}
% \includegraphics[width=.6\textwidth]{../figures/country_comparison/hit_by_covid_FR.png} # TODO choose
% \end{figure}
% \end{frame}

\section{Political Views}

\begin{frame}{Interest in politics }%\addtocounter{framenumber}{-1}
\vspace{-.5cm}
\begin{figure}[h!]
...
\begin{frame}{Environmental organizations}%\addtocounter{framenumber}{-1}
\vspace{-.5cm}
\begin{figure}[h!]
...
\begin{frame}{Major election vote}%\addtocounter{framenumber}{-1}
\vspace{-.5cm}
\begin{figure}[h!]
...
% \caption{Which candidate did you vote for in the last presidential election?}
% \includegraphics[width=.6\textwidth]{../figures/country_comparison/vote_all_FR.png} \\
% \caption{Did you vote in the 2016 French presidential election?}
% \includegraphics[width=.54\textwidth]{../figures/country_comparison/vote_participation_2016_FR.png}\\
\end{figure}
\end{frame}
...
%\includegraphics[width=.8\textwidth]{../figures/country_comparison/political_affiliation_FR.png}\\
\end{figure}
\end{frame}
...
% \includegraphics[width=.7\textwidth]{../figures/country_comparison/transport_FR.png} \\
% \vspace{.5cm}
% TODO: add this one or too much info on one graph?
...
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/CC_field_FR.png} \\
% \end{figure}
% \end{frame}
...
%\end{itemize}
%
%% \includegraphics[width=.7\textwidth]{../figures/country_comparison/know_treatment.png}
%\includegraphics[width=.7\textwidth]{../figures/country_comparison/know_treatment_climate_FR.png} \\
%\vspace{.5cm}
%\includegraphics[width=.7\textwidth]{../figures/country_comparison/know_treatment_policy_FR.png}
%\end{figure}
%\end{frame}
...
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/CC_real_FR.png} \\
% \centering
% \caption{\textit{If answered yes to previous question:} What part of climate change do you think is due to human activity?}
% \includegraphics[width=.6\textwidth]{../figures/country_comparison/CC_anthropogenic_non_deniers_FR.png} # TOOD choose
...
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/scores_footprint_FR.png} \\
% \centering
% \caption{Rank the French/China/Western Europe/India in terms of GHG footprint}
% \includegraphics[width=.6\textwidth]{../figures/country_comparison/score_footprint_regions_FR.png}
% \vspace{.2cm}
% % \\
% % \small{Correct ranking: plane>car>coach, beef>chicken>pasta, coal>gas>wind/ US>Western Europe>China>India} \\
% \end{figure}
...
% \includegraphics[width=.3\textwidth]{../figures/country_comparison/footprint_transport_FR.png} \\
% \centering
% \caption{Which dish emits the most greenhouse gases? We consider that each dish weighs half a pound.
% Please rank the items from 1 (most) to 3 (least).}
% \includegraphics[width=.3\textwidth]{../figures/country_comparison/footprint_food_FR.png}
% \end{figure}
% \end{frame}
...
% \includegraphics[width=.3\textwidth]{../figures/country_comparison/footprint_elec_FR.png} \\
% \end{figure}
% \begin{figure}[h!]
% \centering
...
% \includegraphics[width=.75\textwidth]{../figures/country_comparison/footprint_region_no_miss_FR.png}
% \end{subfigure}
% \hfill
% \begin{subfigure}[b]{0.49\textwidth}
% \centering
...
% \includegraphics[width=.75\textwidth]{../figures/country_comparison/footprint_pc_no_miss_FR.png}
% \end{subfigure}
% \end{figure}
% \end{frame}
...
% \includegraphics[width=.8\textwidth]{../figures/country_comparison/CC_responsible_FR.png}
% \end{figure}
% \end{frame}
...
% \includegraphics[width=.7\textwidth]{../figures/country_comparison/pro_ambitious_policies_FR.png}
\end{figure}
\end{frame}
...
% \includegraphics[width=.7\textwidth]{../figures/country_comparison/CC_will_end_countries.png}\\
...
To what extent would you be willing to adopt the following behaviors? (postive answers)}
...
\begin{figure}[h!]
\centering
\caption{How important are the factors below in order for you to adopt a sustainable lifestyle (i.e. limit driving, flying, and consumption, cycle more, etc.)? (positive answers)}
...
%\begin{figure}[h!]
%\centering
%\includegraphics[width=.6\textwidth]{../figures/country_comparison/future_richness_FR.png}
%\end{figure}
%\end{frame}
...
\begin{figure}[h!]
\centering
\caption{Do you agree or disagree with the following statements? A ban on combustion-engine cars would… (positive answers)}
...
\begin{figure}[h!]
\centering
\caption{Do you agree or disagree with the following statements? A green infrastructure program would… (positive answers)}
...
% \includegraphics[width=.8\textwidth]{../figures/country_comparison/investments_funding_countries.png}
% \end{figure}
% \end{frame}
...
\begin{figure}[h!]
\centering
\caption{Do you agree or disagree with the following statements? A carbon tax with cash transfers would… (positive answers)}
...
% % \includegraphics[width=.7\textwidth]{../figures/country_comparison/policies_win_lose_self_FR.png}
% % \vspace{-.1cm}
% % \centering
...
% % \includegraphics[width=.7\textwidth]{../figures/country_comparison/policies_win_lose_rural_FR.png}
% % %\caption{}
% % \end{figure}
% % \end{frame}
...
% % \includegraphics[width=.7\textwidth]{../figures/country_comparison/policies_win_lose_rich_FR.png}
% % \vspace{-.1cm}
% % \centering
...
% % \includegraphics[width=.7\textwidth]{../figures/country_comparison/policies_win_lose_poor_FR.png}
% % %\caption{}
% % \end{figure}
% % \end{frame}
...
% % \includegraphics[width=.7\textwidth]{../figures/country_comparison/policies_win_lose_middle_FR.png}
% % %\caption{}
% % \end{figure}
% % \end{frame}
...
% % \includegraphics[width=.9\textwidth]{../figures/country_comparison/policies_large_effect_FR.png}
% % \vspace{-.1cm}
% % \centering
...
% % \includegraphics[width=.9\textwidth]{../figures/country_comparison/policies_negative_effect_FR.png}
% % %\caption{}
% % \end{figure}
% % \end{frame}
...
% % \includegraphics[width=\textwidth]{../figures/country_comparison/policies_cost_effective_FR.png}
% % %\caption{}
% % \end{figure}
% % \end{frame}
...
% % \includegraphics[width=.8\textwidth]{../figures/country_comparison/policies_fair_FR.png}
% % \vspace{-.1cm}
% % \centering
% % \caption{\textit{Comparison of responses to each policy question:} do you support or oppose \textit{the following policy}?}
% % \includegraphics[width=.8\textwidth]{../figures/country_comparison/policies_support_FR.png}
% % %\caption{}
% % \end{figure}
...
\begin{figure}[h!]
\centering
\caption{Do you support or oppose the following climate policies? (positive answers)}
\vspace{2mm}
...
\begin{figure}[h!]
\centering
\caption{Governments can use the revenues from carbon taxes in different ways. Would you support or oppose introducing a carbon tax that would raise gasoline prices by 10 centimes par litre, if the government used this revenue to finance... (positive answers)}
\vspace{2mm}
...
\includegraphics[width=.35\textwidth]{../figures/country_comparison/wtp_positive_countries.png} % TODO! scale. TODO: wtp_FR_anthropogenic?
\end{figure}
\end{frame}
...
% \includegraphics[width=.9\textwidth]{../figures/country_comparison/donation_agg_countries.png}
% \end{figure}
...
% \includegraphics[width=1\textwidth]{../figures/country_comparison/if_other_do_FR.png} \\
\end{figure}
\end{frame}
...
% \includegraphics[width=.6\textwidth]{../figures/country_comparison/will_insulate_countries.png} \\
% %\caption{Could you trust the federal goverment to implement the following policies}
% % \vspace{.1cm}
...
% % \includegraphics[width=.54\textwidth]{../figures/country_comparison/obstacles_insulation_FR.png}\\
% % \end{figure}
% \end{frame}
...
% \vspace{.5cm}
% \includegraphics[width=.64\textwidth]{../figures/country_comparison/ban_incentives_FR.png}
\end{figure}
\end{frame}
...
% % \includegraphics[width=1\textwidth]{../figures/country_comparison/beef_FR.png} 
% % % \vspace{.5cm}
% % % \includegraphics[width=.64\textwidth]{../figures/country_comparison/ban_incentives_FR.png}
% % \end{figure}
% % \end{frame}
...
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/future_richness_countries.png}
\end{figure}
\end{frame}
...
% \includegraphics[width=.3\textwidth]{../figures/country_comparison/comment_field_FR.png}
\end{figure}
\end{frame}
...
% %\includegraphics[width=.6\textwidth]{../figures/country_comparison/willing_limit_flying_FR_pol.png} \\
% %\vspace{.5cm}
...
% %\includegraphics[width=.7\textwidth]{../figures/country_comparison/willing_limit_beef_FR_pol.png} \\
% %\end{figure}
% %\end{frame}
% %
...
% %\includegraphics[width=.7\textwidth]{../figures/country_comparison/future_richness_FR_pol.png} \\
% %\vspace{.5cm}
...
% %\includegraphics[width=.7\textwidth]{../figures/country_comparison/effect_halt_CC_lifestyle_FR_pol.png} \\
% %\end{figure}
% %\end{frame}
% %
...
% %\includegraphics[width=.6\textwidth]{../figures/country_comparison/policies_win_lose_self_FR_pol.png} \\
% %\vspace{.1cm}
...
% %\includegraphics[width=.5\textwidth]{../figures/country_comparison/CC_affects_self_FR_pol.png}
% %\end{figure}
% %\end{frame}
% %
...
% %\includegraphics[width=.6\textwidth]{../figures/country_comparison/policies_support_FR_pol.png} \\
% %\vspace{.5cm}
...
% %\includegraphics[width=.6\textwidth]{../figures/country_comparison/global_assembly_support_FR_pol.png} \\
% %\end{figure}
% %\end{frame}
% %
...
% %\includegraphics[width=.8\textwidth]{../figures/country_comparison/policies_negative_effect_FR_pol.png} \\
% %\end{figure}
% %\end{frame}
...
% % \includegraphics[width=.6\textwidth]{../figures/country_comparison/willing_limit_flying_FR_inc.png} \\
% % \vspace{.5cm}
% % \caption{To what extent would you be willing to adopt the following behaviors? -- Limit Beef Consumption, by Income}
% % \includegraphics[width=.7\textwidth]{../figures/country_comparison/willing_limit_beef_FR_inc.png} \\
% % \end{figure}
% % \end{frame}
...
% \includegraphics[width=.7\textwidth]{../figures/country_comparison/future_richness_FR_inc.png} \\
% \vspace{.5cm}
...
% \includegraphics[width=.7\textwidth]{../figures/country_comparison/effect_halt_CC_lifestyle_FR_inc.png} \\
% \end{figure}
% \end{frame}
...
% \includegraphics[width=.6\textwidth]{../figures/country_comparison/policies_win_lose_self_FR_inc.png} \\
% \vspace{.1cm}
...
% \includegraphics[width=.5\textwidth]{../figures/country_comparison/CC_affects_self_FR_inc.png}
% \end{figure}
% \end{frame}
...
% \includegraphics[width=.6\textwidth]{../figures/country_comparison/policies_support_FR_inc.png} \\
% \vspace{.5cm}
...
% \includegraphics[width=.6\textwidth]{../figures/country_comparison/global_assembly_support_FR_inc.png} \\
% \end{figure}
% \end{frame}
...
% \includegraphics[width=.8\textwidth]{../figures/country_comparison/policies_negative_effect_FR_inc.png} \\
% \end{figure}
% \end{frame}
