...
# TODO AF: robust standard errors; add Gilets_jaunes analysis (they support more climate policies, except for the carbon tax with cash transfers); (decimale 0% barres)
