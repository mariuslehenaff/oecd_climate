...
indices_list <- c("index_progressist", "index_knowledge", "index_affected", "index_concerned_about_CC", "index_worried", "index_positive_economy", "index_constrained",
                  "index_policies_efficient", "index_care_poverty", "index_altruism","index_affected_subjective","index_willing_change", "index_lose_policies_subjective", "index_fairness", "index_trust_govt", "index_lose_policies_poor", "index_lose_policies_rich", "index_preferences_pricing_norms")
...
indices_lab <- c("Is progressist", "Has a good knowledge of climate change", "Is affected by climate change", "Is concerned about climate change", "Is worried about the future", "Climate policies have a positive effect on the economy",
                 ...
                 "Thinks poor people will lose from main policies", "Thinks rich people will lose from main policies", "Support more pricing policies than norms")
...
standard_var_non_standardized <- calc.relimp(models[[1]], type = c("lmg"), rela = F, rank= F)
standard_var_non_standardized <- calc.relimp(models[[1]], type = c("lmg"), rela = F, rank= F)
tax_transfers_var_standardized <- calc.relimp(models[[2]], type = c("lmg"), rela = T, rank= F, always = controls_lmg)
tax_transfers_var_non_standardized <- calc.relimp(models[[2]], type = c("lmg"), rela = F, rank= F, always = controls_lmg)
investments_var_standardized <- calc.relimp(models[[3]], type = c("lmg"), rela = T, rank= F, always = controls_lmg)
investments_var_non_standardized <- calc.relimp(models[[3]], type = c("lmg"), rela = F, rank= F, always = controls_lmg)
main_policies_var_standardized <- calc.relimp(models[[4]], type = c("lmg"), rela = T, rank= F, always = controls_lmg)
main_policies_var_non_standardized <- calc.relimp(models[[4]], type = c("lmg"), rela = F, rank= F, always = controls_lmg)
