...
# TODO!!: code CSP, cu, share of policies approved, consistency_answers/quality (max_footprint_reg = 1, tax_transfers 2 kinds, CC_field_na, weird_good_CC_field), CC_field, feedback, score_trust, index_pro_climate, vote, ranking vs. order of display
...
{ 
  ...
  "UK" = list(
    ...
    "urban" = c(FALSE, TRUE),
    "UK_urban_category" = c(0.176, 0.401, 0.423),
