...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/01 Distributional/interactions/06.mechanisms_dist_01.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
...
#delimit ; 
eststo : reg dummy_Q0600`x' i.group
	women kids i.race_agg i.agegroup_agg 
	i.incomegroup_agg 
	i.college_degree_area i.employment_agg i.knowledge_econ_agg
	i.candidate_econ,  base ; 
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/01 Distributional/interactions/06.mechanisms_dist_02_06.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
foreach x in 1 2 {
#delimit ; 
eststo : reg dummy_Q06007_`x' i.group
	women kids i.race_agg i.agegroup_agg 
	i.incomegroup_agg 
	i.college_degree_area i.employment_agg i.knowledge_econ_agg
	i.candidate_econ,  base ; 
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/01 Distributional/interactions/06.mechanisms_dist_07.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
drop dummy_Q06001_1 dummy_Q06001_2 dummy_Q06001_3 dummy_Q06001_4 dummy_Q06001_5
...
replace dummy_Q06001_1 = 1 if(Q06001_1_en > 3 & Q06001_1_en < 6)
replace dummy_Q06001_2 = 1 if(Q06001_2_en > 2 & Q06001_2_en < 6)
replace dummy_Q06001_3 = 1 if(Q06001_3_en > 3 & Q06001_3_en < 6)
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/01 Distributional/interactions/06.mechanisms_dist_01_v2.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
#delimit ; 
eststo : reg dummy_Q060`x' i.group
	women kids i.race_agg i.agegroup_agg 
	i.incomegroup_agg 
	i.college_degree_area i.employment_agg i.knowledge_econ_agg
	i.candidate_econ,  base ; 
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/02 Efficiency/interactions/06.mechanisms_eff_08_12.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/03 Case Study/interactions/06.mechanisms_case_21_22.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/03 Case Study/interactions/06.mechanisms_case_13_14.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear	
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/03 Case Study/interactions/06.mechanisms_case_15_17.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear	
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/03 Case Study/interactions/06.mechanisms_case_18_20.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
esttab using "$trade/Output/Tables/Reg_tables/06 Mechanisms/03 Case Study/interactions/06.mechanisms_case_23_24.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
#delimit ; 
eststo : reg dummy_Q0700`var' i.group
	women kids i.race_agg i.agegroup_agg 
	i.incomegroup_agg 
	i.college_degree_area i.employment_agg i.knowledge_econ_agg
	i.candidate_econ,  base ; 
...
esttab using "$trade/Output/Tables/Reg_tables/07 Specific Outcomes/interactions/07.outcomes.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
#delimit ; 
eststo : reg dummy_Q07006_`var' i.group
	women kids i.race_agg i.agegroup_agg 
	i.incomegroup_agg 
	i.college_degree_area i.employment_agg i.knowledge_econ_agg
	i.candidate_econ,  base ; 
...
esttab using "$trade/Output/Tables/Reg_tables/07 Specific Outcomes/interactions/07.outcomes_06.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
esttab using "$trade/Output/Tables/Reg_tables/07 Specific Outcomes/interactions/07.outcomes_04_05.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
foreach x in  2 3 {
#delimit ; 	
	eststo : reg dummy_G0800`x' i.group
	women kids i.race_agg i.agegroup_agg 
	i.incomegroup_agg
	i.college_degree_area i.employment_agg i.knowledge_econ_agg
	i.candidate_econ
...
esttab using "$trade/Output/Tables/Reg_tables/08 General Outcomes/interactions/08.general_outcomes_A.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
...
foreach x in 1 2 3 4 5 {
#delimit ; 	
	eststo : reg dummy_G08004_`x' i.group
	women kids i.race_agg i.agegroup_agg 
	i.incomegroup_agg
	i.college_degree_area i.employment_agg i.knowledge_econ_agg
	i.candidate_econ
...
esttab using "$trade/Output/Tables/Reg_tables/08 General Outcomes/interactions/08.general_outcomes_B.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
...
#delimit ; 
eststo : reg dummy_Q09003 i.group
	women kids i.race_agg i.agegroup_agg 
	i.incomegroup_agg 
	i.college_degree_area i.employment_agg i.knowledge_econ_agg
	i.candidate_econ, base ; 
...
esttab using "$trade/Output/Tables/Reg_tables/09 Specific Government/interactions/09.spec_gov.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
esttab using "$trade/Output/Tables/Reg_tables/10 General Government/interactions/10.general_gov_A.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
...
esttab using "$trade/Output/Tables/Reg_tables/10 General Government/interactions/10.general_gov_C.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0))  width(1 \hsize) noconstant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
...
esttab using "$trade/Output/Tables/Reg_tables/10 General Government/interactions/10.general_gov_D.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0))  width(1 \hsize) noconstant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace 
eststo clear
...
esttab using "$trade/Output/Tables/Reg_tables/99 WTP/wtp_interactions.tex", cells(b(fmt(2) star) se(par fmt(2))) collabels(none) label  ///
		stats(mean_control N, fmt(2 0)) constant not starlevels(* 0.1 ** 0.05 *** 0.01) r2 replace
eststo clear
